namespace Fpi.Ppg.UI
{
	partial class SplashForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.applicationNameLabel.Text = "FPI PPG";
			this.applicationNameLabel.Click += new System.EventHandler(this.SplashForm_Click);
			// 
			// versionLabel
			// 
			this.versionLabel.AutoSize = true;
			this.versionLabel.Location = new System.Drawing.Point(121, 51);
			...
			this.copyrightLabel.Location = new System.Drawing.Point(121, 90);
			this.copyrightLabel.Name = "copyrightLabel";
			this.copyrightLabel.Size = new System.Drawing.Size(202, 13);
			this.copyrightLabel.TabIndex = 4;
			this.copyrightLabel.Text = "Copyright © 2007 Fridge Productions Inc.";
